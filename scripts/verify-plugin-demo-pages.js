...
mustContain('pluginImport', ['/api/plugin/parse-table', 'isLikelyPdf', 'pickSmart', '.pdf', 'onSourcePreview', 'renderInlinePreview', 'cameraCapture', 'yy-import-btn-cam'], 'plugin-import PDF guard and mobile camera');
mustContain('ocrImport', ['parseImages: true', 'pickSmart', 'fee_list', 'onSourcePreview', 'showSourceDocument', 'hisSource', 'cameraCapture: true', 'ocr-mobile-tip'], 'OCR import mobile-first and source preview');
